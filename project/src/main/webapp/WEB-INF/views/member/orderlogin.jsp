...
<body>
		...
		<table id="logintable" >
			<tr>
			<td><input type="text" id="m_id" placeholder="아이디를 입력하세요 "/>	</td></tr>
			<tr><td><input type="password" id="m_pw" placeholder="비밀번호를 입력하세요. "/></td></tr>
			<tr><td><a onclick="go_login()" style="background-color: black; color: white;">로그인</a></td></tr>
			<tr><td><a style="background-color: #2d8400; color: white;">네이버로그인</a></td></tr>
			<!-- <tr><td><a style="background-color: #f9e000;">카카오로그인</a></td></tr>
			<tr><td><a href="member" style="border: 1px solid gray;">회원가입</a></td></tr> -->
			<tr><td><a href="nomemberorder.buy" style="border: 1px solid gray;">비회원구매</a></td></tr>
			<tr>
				<td><a href="findform_id.jsp">아이디 찾기</a>
				<a>비밀번호 찾기</a></td>
			</tr>
		</table>

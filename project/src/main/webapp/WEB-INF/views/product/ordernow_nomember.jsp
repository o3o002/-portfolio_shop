...
<div class="buylist">
	<input type="hidden" value="${p_info_no }" name="p_info_no"/>
			...
			<table>
					<tr>
						...
						<td><input type="radio" name="paymethod" value="무통장입금" checked="checked"/>무통장입금
								<input type="radio" name="dd" value="네이버페이"/>네이버페이 
								<input type="radio" name="dd" value="카카오페이">카카오페이 
								<input type="radio" name="pathod" value="휴대폰결제"/>휴대폰결제 
								<input type="radio" name="paod" value="카드결제"/>카드결제 
						</td>
					</tr>
							...
							<div id="cash">
								...
								<tr><th><i class="require_sing">* </i>입금은행</th>
										<td><select name="cash_bank" class="cash_blank" >
												...
												<option value="NH">농협:11234-56789</option>

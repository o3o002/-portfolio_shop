...
<body>
	<div style="display:table; margin: 0 auto;" class='detail_top'>
			...
			<div class='item_info'>
					...
					<div class='totalProducts' style="display: none">
						<form id="basket" method="post" action="basketInsert.buy" >
							...
							<table id='product_option' style="font-size: 14px;">	
									<tfoot>				
									<tr><td colspan="4"><p>총 합계 : 00원</p></td></tr></tfoot>
							</table>							
						</form>
					...
					<a href="write.rv?p_num=${pd.p_num }">review쓰기</a>
			</div>
...
//	str +="<li><input type='text' name='content' placeholder='댓글을 남겨주세요 :)'/><a class='btn' onclick='repley_insert()'>등록</a></li>"
//	

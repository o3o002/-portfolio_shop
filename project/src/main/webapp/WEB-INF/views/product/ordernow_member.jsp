	...
	<table >
		<tr style="background-color: #f5edd7;'">
			...
			<c:set var="count" value="0"/>
				<tr>
					<td>이미지</td>
					<td class="left"><a href="go_detail?id=${product.p_num }"><p style="font-weight: bold;">${product.p_name }</p></a>
		...
		<tr>
			<td colspan="7" style="text-align:right; font-size: 14px;" >
					총 <fmt:formatNumber value="${basket.price }" pattern="#,###"/>원
			</td>
		</tr>
		 </tfoot>
	</table>
		...
		<form method="post" action="orderinfo.buy">
			...
			<table >
				<tr><th>주문하시는 분<i class="require_sing">* </i></th>
						<td><input type="text" name="sender" class="chk" value="${loginInfo.m_name }"></td></tr>
				<tr class="addr"><th >주소<i class="require_sing">* </i></th>
						<td><input type=text   class="chk" name="s_post" class='wpx70' readonly="readonly" value=${loginInfo.post }/><a class='btn-fill-s senderpost' >우편번호</a><br/>
								<input type="text" class="chk" name="s_addr" readonly="readonly" value="${loginInfo.m_addr }"/><br/>
								<input type="text" class="chk" name="s_addr2"> 나머지주소
						</td>
				</tr>
				<tr><th>휴대폰번호<i class="require_sing">* </i></th>
						
						<td><input type="number" value="${tel0 }" name="s_phone" class="chk" value="010"/>-
								<input type="number" value="${tel1 }" name="s_phone" class="chk" maxlength="4"/>-
								<input type="number" value="${tel2 }" name="s_phone" class="chk" maxlength="4"/>
						</td>
				</tr>
				<tr><th>일반전화</th>

...
<h4><a href="#"> ${fn:toUpperCase(page.itemType1) }</a></h4>
<form method="post" action="list.pd" id="list">
...
<div id='view_type'>
	<ul>
		<li><a>리뷰순</a></li>	
		<li><a href='list.pd?itemType1=${page.itemType1 }&sort=hightprice'>높은가격</a></li>	
		<li><a href='list.pd?itemType1=${page.itemType1 }&sort=lowprice'>낮은가격</a></li>	
		<li><a href='list.pd?itemType1=${page.itemType1 }&sort=update'>신상품순</a></li>
	</ul>
</div>

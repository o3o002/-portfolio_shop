...
<body>
<h4>MEMBER ORDER FORM</h4>
<form method="post" action="insert.od">
<div class="buylist">
	...
	<div id="orderarea" class="form_area">
			...
			<table >
				...
				<tr><th>휴대폰번호<i class="require_sing">* </i></th>
						<td><input type="number" name="s_phone" class="chk" value="${tel0 }"/>-
								<input type="number" name="s_phone" class="chk"  value="${tel1 }" maxlength="4"/>-
								<input type="number" name="s_phone" class="chk" value="${tel2 }" maxlength="4"/>
						</td>
				</tr>
				<tr><th>일반전화</th>
						...
						<td id="paymethod_area" colspan="3">
							...
							<div id="cash">
								...
								<tr><th><i class="require_sing">* </i>입금자명</th>
										<td><input type="text" class='chk' name="cash_name" class="cash_blank"/>
								</tr>
